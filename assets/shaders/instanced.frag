...
// =============================================================================
// PBR Instanced Fragment Shader - Based on Google's Filament Standard Model
// =============================================================================
// For instanced geometry rendering with PBR lighting.
// =============================================================================
...
in vec3 v_Color;       // Per-instance color
in vec3 v_ViewPos;
in vec3 v_Normal;
in vec3 v_FragPos;
...
// PBR Material Parameters (for instanced rendering, use per-instance color as base)
...
void main() {
    ...
    // Use per-instance color as base color
    vec3 baseColor = v_Color;
    
    // Get PBR parameters (or use defaults)

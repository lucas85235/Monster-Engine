#!/usr/bin/env python3
"""
Animation Editor — Cross-platform build script.

Usage:
    python tools/animation_editor/scripts/build.py [config]
"""
...
# Import shared utilities from the root scripts/ directory
...
def main() -> None:
    ...
    u.info("========================================")
    u.info(f"  Animation Editor - Build Script ({u.detect_platform()})")
    u.info("========================================")
    print()

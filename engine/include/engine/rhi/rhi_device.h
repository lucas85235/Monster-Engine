...
class IDevice {
   public:
     ...
     */
    virtual void UpdateBuffer(BufferHandle buffer, const void* data, uint32_t size, uint32_t offset = 0) = 0;
     ...
     */
    virtual void UpdateTexture(TextureHandle texture, const void* data, uint32_t mipLevel = 0) = 0;
     ...
     */
    virtual void UpdateTextureCubeFace(TextureHandle texture, CubemapFace face, const void* data, uint32_t mipLevel = 0) = 0;
     ...
     */
    virtual PipelineHandle CreatePipeline(const PipelineDescriptor& desc, ShaderHandle shader, const VertexLayout& layout) = 0;
     ...
     */
    virtual void AttachTexture(FramebufferHandle framebuffer, FramebufferAttachment attachment, TextureHandle texture) = 0;

    /**
     * @brief Obtém a textura de um attachment do framebuffer
     */
    virtual TextureHandle GetFramebufferTexture(FramebufferHandle framebuffer, FramebufferAttachment attachment) = 0;

    /**
     * @brief Redimensiona um framebuffer
     */
    virtual void ResizeFramebuffer(FramebufferHandle framebuffer, uint32_t width, uint32_t height) = 0;
     ...
     */
    virtual void DrawSkybox(TextureHandle cubemap, SamplerHandle sampler, const float* viewMatrix, const float* projMatrix) = 0;

...
class OpenGLOcclusionQuery : public IOcclusionQuery {
   public:
    ...
    uint32_t GetHandle() const override { return queryId_; }
...
class OpenGLOcclusionQueryPool : public OcclusionQueryPool {
   public:
    ...
    uint32_t GetPoolSize() const override { return poolSize_; }
    uint32_t GetActiveCount() const override { return activeCount_; }

...
struct PBRMaterialParams {
    ...
    float Roughness = 0.5f;                      // Perceptual roughness (squared in shader)
 ...
 * Uses Spherical Harmonics for efficient diffuse irradiance.
 */
struct IBLData {
    ...
    // TODO: Prefiltered environment cubemap
    // TODO: DFG LUT texture

...
void RenderCommand::DrawIndexedInstanced(const VertexArray* vertexArray, uint32_t instanceCount,
                                         uint32_t indexCount) {
...
void RenderCommand::DrawArraysInstanced(const VertexArray* vertexArray, uint32_t vertexCount,
